...
SM.Cmd = (function () {
  ...
  var LIST = [
    ...
    { id: 'show.photo', label: 'Draped orthophoto', icon: 'raster',
      hint: 'Show or hide the georeferenced photo draped over the terrain.',
      enabled: function () { return SM.Photo.has(); },
      toggle: function () { return S.photo.on; },
      run: function () { SM.Photo.setOn(!S.photo.on); } },
  ...
  var MENUS = [
    ...
    { title: 'View', items: ['view.fit', 'view.plan', 'view.iso', 'view.eye', '-',
      'show.surface', 'show.flat', 'show.photo', '-',
