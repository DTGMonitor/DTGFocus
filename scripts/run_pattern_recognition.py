...
# ---------------------------------------------------------------------------
# Add the pattern-recognition module directory to sys.path so that the
# pipeline modules (preprocessor, phase_classifier, etc.) can be imported.
# ---------------------------------------------------------------------------
_PIPELINE_DIR = os.path.join(os.path.dirname(__file__), "..", "..", "pattern-recognition")
_PIPELINE_DIR = os.path.normpath(_PIPELINE_DIR)
